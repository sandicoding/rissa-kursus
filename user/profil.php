...
?>
	...
	<div id="proff">
		...
		<div id="eg">
			<a href="editprofil" class="pass2" style="color: yellow" > Ubah/Upload Foto</a>
			<a href="#gantipassword" class="pass" style="color: red"> Ganti Password</a>
		</div>
		</div>
	</div>
