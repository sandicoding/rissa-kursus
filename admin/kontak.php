		...
		<center>
			...
			<div id="kanan">
				...
				<div style="text-align: left; ">
					<p style="text-align: center; margin-top: 3px; margin-left: 10px; margin-right:625px; padding: 2px; background: #11022a; color: white; font-weight: bold;"><?php echo $username ?></p>
				</div>
				
				<div style="background: #0000; padding: 3px; text-align: left;margin-left: 10px;  margin-right: 200px; margin-top: 0; font-style: italic; font-weight: bold;">
					<?php echo $pesanuser ?>
				</div>
				<?php 
					}
				...
				<div align="right" style="background: #0000; padding: 3px; text-align: left;margin-left: 200px; margin-top: 0; font-style: italic; font-weight: bold;">
					<?php echo $pesanadmin ?>
				</div>
				<?php
					}
				...
				<form method="post" action="fungsi/proseskontak" style="margin-top: 0; margin-left: 10px;">
					...
					<button type="submit" align="left" style="width:70px;background:#11022a;color:white;font-weight:bold;padding:4px;border:1px solid red;" name="ok">Kirim</button>
				</form>
				</details>
			  	<?php
